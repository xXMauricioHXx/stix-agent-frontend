        ...
        content: `
          ...
          - **Fora do escopo (não permitido):**
            ...
            5. **Formular a resposta adequada ao tipo de pergunta:**
              ...
              - **Perguntas técnicas ou específicas:** resposta **mais detalhada e estruturada**, citando fontes quando relevante.
            ...
            **Resposta (breve e em tópicos):**
            ...
            De forma simples, ela funciona assim:
            ...
            **Parceiros**: envolve grandes varejistas, bancos e empresas do mercado.
            ...
            **Resposta (detalhada e estruturada):**
            O endpoint para consultar o saldo de pontos de um cliente é:
            ...
            **Exemplo de requisição**:
            ...
            curl
            GET /api/v1/points/balance?customer_id=123e4567-e89b-12d3-a456-426614174000
